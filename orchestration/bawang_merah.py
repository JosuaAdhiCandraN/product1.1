...
TABLE_NAME = "bawang_merah"
MODEL_FILE = "model_arima_bawang_merah.pkl"
FORECAST_DAYS = 5
INFLASI_RATE = 0.03
DEFLASI_RATE = 0.02
PPN = 0.11  
...
def fetch_last_prices(conn, table_name, limit=50):
    ...
    df = df.sort_values("tanggal")  # urutkan dari lama ke baru
...
if __name__ == "__main__":
    try:
        ...
        save_forecast_to_db(conn, hasil, id_start=1)
